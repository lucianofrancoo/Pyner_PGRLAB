#!/usr/bin/env python3
"""
🚀 QUICK TEST: Generación de Queries (MVP) - Moved to Query_generator/
==========================================
...
print("\n🧪 QUICK TEST: Query Generation (Query_generator)\n")
...
print("  python3 Query_generator/demo_query_generator.py interactive")
print("\nPara el demo con ejemplos:")
print("  python3 Query_generator/demo_query_generator.py")
print("=" * 70 + "\n")
